...
#' A list of the SimcypConsultancy Team's favorite colors
#' 
#' @format a named list of character vector of colors
#' @examples
#' scales::show_col(OurFavoriteColors$Shinji)
"OurFavoriteColors"
...
#'
#' Enzyme-abundance levels for liver CYP3A4 in the presence and absence of
...
#'
#' Enzyme-abundance levels for CYP3A4 in the colon and in the small intestine in
