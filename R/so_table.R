...
#'   output from the function \code{\link{getSectionInfo}}.
#' @param report_input_file the name of the Excel file to be piped to
#'   \code{\link{getSectionInfo} if \code{sectionInfo} is NA
#' @param sheet the sheet name to read if \code{sectionInfo} is NA
...
so_table <- function(sectionInfo = NA,
      ...
      # Just keeping a copy of original output from extractPK temporarily... I
      # may delete this bit from final code... -LS
