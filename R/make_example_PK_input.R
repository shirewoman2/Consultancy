#' Examples for supplying PK parameters to pksummary functions
#'
...
#' \code{\link{pksummary_table}} or \code{\link{pksummary_mult}}. You can either
#' just get a printout in the console of the parameters you want or you can get
#' an example csv file to use a as a template.
#'
#'
...
make_example_PK_input <- function(){
   ...
   message(str_wrap("Do you want to just see the R code names for these PK parameters or do you want to make a csv file with examples for how to enter data for the pksummary functions?\n"))
