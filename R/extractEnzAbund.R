...
#'   abundances 1. in the presence or 2. the absence of Inhibitor 1 and any
#'   other effectors. If there were multiple inhibitors or effectors, it does
#'   not show enzyme abundances with each separately.)}
#'
