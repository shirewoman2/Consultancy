...
#' round_up, round_down, round_up_nice, round_up_unit, round_down_unit
#'
#' Round a number or vector of numbers up or down to nice intervals. \describe{
...
#'
#'
round_up      <- function(x) {10^ceiling(log10(x))} # function to round up to the nearest power of 10
