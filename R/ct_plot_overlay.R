...
#'   running the function \code{\link{extractConcTime_mult}} or
...
#' @param colorBy_column the column in \code{ct_dataframe} that should be
...
#'   \code{ct_dataframe}. What should be the 1st column to break up the
