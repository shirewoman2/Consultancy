...
#' used. This is meant for generating XML files for use in Phoenix WNL. If you
#' need the same value for all items, it's fine to only specify it once
#' manually; it will be repeated as needed.
#'
