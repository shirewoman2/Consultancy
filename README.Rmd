...
You do *not* need to read this document from start to finish to follow it. Instead, please do use the navigation pane to skip around to only the parts that interest you. For help on any functions, type a question mark followed by the name of the function. For example, here's how to get help on the ct_plot function:  
