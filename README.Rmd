...
- [Time savers for setting up workspaces](#time-savers-for-setting-up-workspaces)  
- [Check how simulations were set up, e.g., for QCing](#check-how-simulations-were-set-up--e-g---for-qcing)  
...
# Timesavers for setting up workspaces {#Timesavers}
