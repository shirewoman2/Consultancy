...
- [Time savers for setting up workspaces](https://github.com/shirewoman2/Consultancy/tree/beta?tab=readme-ov-file#timesavers-for-setting-up-workspaces)  
- [Check how simulations were set up, e.g., for QCing](#QCing)  
- [Make concentration-time plots](readme-ov-file#make-concentration-time-plots)  
