...
# How could I do this w/out nested ifelse statements?
PlotType <- ifelse(EnzPlot, 
                   "EnzPlot", 
                   ifelse(ReleaseProfPlot, 
                          "RelProf", "CTPlot"))
...
CapText2 <- switch(figure_type, 
                   ...
                   "percentiles" = paste("The lighter lines represent the 5th and 95th percentiles and the darker lines the",
                                         mean_type, 
                   ...
                   "percentile ribbon" = ifelse(ReleaseProfPlot, 
                                                ...
                                                paste("The shaded regions represent the 5th to the 95th percentiles and the darker lines the",
                                                      mean_type, 
                                                      "mean data for the simulated population (n = XXX)")), 
