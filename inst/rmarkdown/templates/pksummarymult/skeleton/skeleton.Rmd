...
if(single_table == FALSE){
   ...
   TableSettings <- c("Tissue", "CompoundID", "File")
   TableSettings <- str_c(TableSettings[TableSettings %in% names(MyPKResults)], 
                          collapse = " ")
   MyPKResults <- 
      split(MyPKResults, 
            f = switch(TableSettings,
                       "Tissue CompoundID File" = list(MyPKResults$Tissue, 
                                                       MyPKResults$CompoundID, 
                                                       MyPKResults$File), 
                       "Tissue File" = list(MyPKResults$Tissue, 
                                            MyPKResults$File), 
                       "CompoundID File" = list(MyPKResults$CompoundID, 
                                                MyPKResults$File), 
                       "File" = list(MyPKResults$File))
      )
