...
$$ \text{fold induction} = 1 + E_{max} \times \frac{I^n}{EC_{50}^n + I^n} $$

where I is the concentration of the inducer, E~max~ is the maximum change in fold induction, EC~50~ is the concentration of the inducer that elicits half the maximum fold-change in induction, and n is the Hill equation coefficient describing the slope. 
...
$$ \text{fold induction} = \frac{Ind_{max}}{1 + e^{ \frac{IndC_{50}-I}{n}}} $$

where I is the concentration of the inducer, Ind~max~ is the maximum fold induction, IndC~50~ is the concentration of the inducer that elicits half the maximum fold induction, and n is the Hill equation coefficient describing the slope. 
...
```{r indFit_sum, fig.width = fig_width, fig.height = fig_height, fig.align = "center"}
...
AllFits <- AllFits %>% 
    ...
    mutate(across(.cols = any_of(c("Emax", "EC50", "slope", "IndC50", "Indmax")), 
                  .fns = round_opt, 
                  round_fun = ifelse(complete.cases(rounding) && rounding == "Word", 
