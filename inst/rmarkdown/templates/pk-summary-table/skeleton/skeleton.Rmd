...
if(exists("sim_data_files", inherits = FALSE)){
    CapText1 <- paste0(ifelse(any(str_detect(names(MyPKResults), "tmax")), 
                              "t~max~: median, min, max; ", ""), 
                       ifelse(str_detect(MyPKResults$Statistic, " CI"),
                              "CI: Confidence Interval; ", ""), 
                       ifelse(str_detect(MyPKResults$Statistic, "CV"),
    ...
    CapText1 <- paste0(ifelse(any(str_detect(PKToPull, "tmax")), 
                              "t~max~: median, min, max; ", ""), 
                       ifelse(str_detect(MyPKResults$Statistic, " CI"),
                              "CI: Confidence Interval; ", ""), 
                       ifelse(str_detect(MyPKResults$Statistic, "CV"),
...
*`r CapText1`Source simulated data: `r CapText2`* 
