...
if(FromCalcPKRatios){
   ...
   PKpulled$PKpulled <- expand.grid(PKpulled$PKpulled = PKToPull, 
...
if(single_table){
   ...
   if(length(MyPKResults$Tissue) == 1){
      MyPKResults <- MyPKResults %>% 
   ...
   # in the table.
   if(length(MyPKResults$CompoundID) == 1){
      MyPKResults <- MyPKResults %>% 
...
if(single_table == FALSE){
   ...
   MyPKResults <- 
      split(MyPKResults, f = list(MyPKResults$File, 
                                  ...
                                  MyPKResults$Tissue))
   PKpulled$PKpulled <- 
      split(PKpulled$PKpulled, f = list(PKpulled$PKpulled$File, 
                               PKpulled$PKpulled$CompoundID, 
                               PKpulled$PKpulled$Tissue))
   ...
   for(i in names(MyPKResults)){
      ...
      rm(Heading, Deets, MyPerpetrator, MyFiles, MyAnnotations, PKpulled$PKpulled_i)
