Figure XXX. Simulated hepatic `r enzyme` levels during the dosing of `r MySubstrate` in the presence and absence of `r MyEffector` to `r tidyPop(existing_exp_details$Population)$Population`. 
...
EnzCaption <- paste0("Depicted are simulated hepatic ",
                     ...
                     DoseDay, " day of ", existing_exp_details$SimDuration/24,
                     " days of dosing of ", MyEffector, 
                     " (dashed line). The lines represent the mean data for the simulated population (n = ",
                     existing_exp_details$NumTrials * existing_exp_details$NumSubjTrial, 
