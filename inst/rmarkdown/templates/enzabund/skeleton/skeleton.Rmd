Figure XXX. Simulated hepatic `r enzyme` levels during the dosing of `r MySubstrate` in the presence and absence of `r MyEffector` to `r tidyPop(Deets$Population)$Population`. 
