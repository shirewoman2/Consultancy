...
#### Simulation of `r str_to_title(SDMD_sub_txt)` of `r exp_details$Dose_sub` mg `r str_to_title(MySubstrate)` Administered with `r MyEffector` in `r tidyPop(exp_details$Population)$PopulationCap` 
