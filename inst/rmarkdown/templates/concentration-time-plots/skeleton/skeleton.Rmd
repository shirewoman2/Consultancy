...
MySubstrate <- unique(ct_dataframe$Compound[ct_dataframe$CompoundID == "substrate"])
MySubstrate <- prettify_compound_name(
    ifelse(length(MySubstrate) == 0, "substrate", MySubstrate))
